...
function generate3FLabels(): LabelData[] {
  ...
  return [
    ...
    { id: 'label-coaching1', label: '코칭룸1', sub: '', x: legendX, y: legendY - legendGap * 3 },
    { id: 'label-coaching2', label: '코칭룸2', sub: '', x: legendX, y: legendY - legendGap * 4 },
...
function generate4FLabels(): LabelData[] {
  ...
  return [
    ...
    { id: 'label-4f-classroom', label: '강의실', sub: '', x: legendX, y: legendY - legendGap * 4 },
...
export default function FloorPlanViewer({
  ...
  const DEFAULT_SEAT_OFFSETS: Record<string, { x: number; y: number }> = {
    ...
    "label-4f-classroom": { "x": 6912, "y": -247 },
