...
export default function AICenter() {
  ...
  const aiTeam = [
    ...
    },
    {
      ...
      description: "• 스나고(SNarGo): 수학 강사 출신 센터장님의 노하우가 담긴 스나고는 고난도 킬러 문항도 막힘없이 풀어냅니다. 단순히 답만 알려주는 게 아니라, '왜 이렇게 풀어야 하는지' 논리적인 과정을 학생 눈높이에서 쉽게 설명해 줍니다.\n\n• 스나겐(SNarGen): 틀린 문제를 다시 풀라고 하면 학생들은 답을 외워서 맞힙니다. 스나겐은 틀린 문제의 핵심 원리만 쏙 뽑아내서, 숫자와 형태가 바뀐 '세상에 하나뿐인 맞춤형 문제'를 즉석에서 만들어줍니다.",
        ...
        <div className="max-w-4xl mx-auto px-6 sm:px-8 lg:px-12 py-24">
          ...
          >
            ...
            <div className="space-y-6 text-gray-400 leading-relaxed">
              <p>
                AI가 학생을 가르친다고 해서 선생님이 멀어지는 것이 아닙니다. 오히려 AI가 단순 반복 업무와 데이터 분석을 맡아주기에, 센터장님과 선생님들은 학생의 눈을 한 번 더 맞추고, 학생의 마음을 더 깊이 상담할 수 있습니다.
              </p>
              <div className="border-l-2 border-[#5a7d6a] pl-5 py-1">
