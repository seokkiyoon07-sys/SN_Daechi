...
export default function AICenter() {
  ...
  return (
    <section id="ai-center" className="py-24 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* 섹션 헤더 */}
        <div className="text-center mb-16">
          <span className="inline-block px-4 py-1.5 bg-sn-green text-white text-sm font-medium rounded-full mb-4">AI Center</span>
          <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">
            AI 특화관
          </h2>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            <span className="text-sn-green font-semibold">AI 기반 학습 시스템</span>으로 효율적인 수능 준비를 지원합니다
          </p>
        </div>
