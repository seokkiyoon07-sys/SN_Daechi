    ...
    <section className="relative overflow-hidden bg-gradient-to-br from-gray-50 to-gray-100">
      ...
      <div className="relative z-10">
        ...
        <div className="min-h-screen flex items-center justify-center text-center py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold text-gray-900 leading-tight px-4 animate-fade-in-up">
      ...
      <div className="relative bg-white">
        ...
        <div className="relative z-10 min-h-screen flex items-center py-24">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
            {/* 제목 */}
            <div ref={titleRef} className="text-center mb-20 opacity-0 scroll-fade-in">
            ...
            <div ref={cardsRef} className="relative max-w-5xl mx-auto">
              ...
              <div className="flex justify-center mb-32 relative z-10">
                <div className="system-card w-full md:w-[45%] bg-white rounded-2xl p-6 shadow-xl border border-gray-200 relative overflow-hidden hover:shadow-2xl transition-shadow opacity-0 scroll-fade-in">
                  {/* AI 글로우 효과 */}
                  ...
                  <h3 className="text-lg font-bold text-gray-900 mb-3 relative text-center">SN AI 시스템</h3>
                <div className="space-y-1 relative">
                  {/* SNarGPT */}
                  <div
                    className="flex items-center gap-2 cursor-pointer hover:bg-blue-50 hover:shadow-sm p-2 rounded transition-all border-b border-gray-100"
                  ...
                  {/* SNarVIS */}
                  <div
                    className="flex items-center gap-2 cursor-pointer hover:bg-purple-50 hover:shadow-sm p-2 rounded transition-all border-b border-gray-100"
                  ...
                  {/* SNarGEN */}
                  <div
                    className="flex items-center gap-2 cursor-pointer hover:bg-purple-50 hover:shadow-sm p-2 rounded transition-all"
              ...
              {/* 하단 두 개 카드 */}
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12 relative z-10 max-w-[90%] mx-auto">
                {/* SN 데이터 플랫폼 */}
                <div className="system-card w-full bg-white rounded-2xl p-6 shadow-xl border border-gray-200 relative overflow-hidden hover:shadow-2xl transition-shadow opacity-0 scroll-fade-in">
                  {/* 데이터 글로우 효과 */}
                  <div className="absolute -bottom-1/2 -left-1/2 w-full h-full bg-gradient-to-tr from-blue-500/10 to-purple-500/10 rounded-full blur-3xl"></div>
                  <h3 className="text-lg font-bold text-gray-900 mb-3 relative text-center">SN 데이터 플랫폼</h3>
                <div className="space-y-1 relative">
                  {/* 온라인 학습량 데이터 */}
                  <div
                    className="flex items-center gap-2 cursor-pointer hover:bg-blue-50 hover:shadow-sm p-2 rounded transition-all border-b border-gray-100"
                  ...
                  {/* 입시 데이터 */}
                  <div
                    className="flex items-center gap-2 cursor-pointer hover:bg-blue-50 hover:shadow-sm p-2 rounded transition-all"
                ...
                <div className="system-card w-full bg-white rounded-2xl p-6 shadow-xl border border-gray-200 relative overflow-hidden hover:shadow-2xl transition-shadow opacity-0 scroll-fade-in">
                  {/* 생활관리 글로우 효과 */}
                  <div className="absolute -bottom-1/2 -right-1/2 w-full h-full bg-gradient-to-tl from-purple-500/10 to-blue-500/10 rounded-full blur-3xl"></div>
                  <h3 className="text-lg font-bold text-gray-900 mb-3 relative text-center">SN 생활관리 시스템</h3>
                <div className="space-y-1 relative">
                  {/* 12시간 집중 학습 관리 */}
                  <div
                    className="flex items-center gap-2 cursor-pointer hover:bg-blue-50 hover:shadow-sm p-2 rounded transition-all border-b border-gray-100"
      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-gray-50 to-gray-100">
        ...
        <div className="relative z-10 pt-24 pb-24">
            ...
            <h2 ref={secondHeadlineRef} className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold text-gray-900 leading-tight mb-20 text-center opacity-0 scroll-fade-in">
            ...
            <div className="max-w-7xl mx-auto mt-32">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
                {/* 수학특화관 */}
                <div className="bg-white rounded-2xl overflow-hidden shadow-xl border border-gray-200 hover:shadow-2xl transition-shadow">
                  ...
                  <div className="p-6 text-center">
                    <h3 className="text-xl font-bold text-gray-900 mb-3">수학특화관</h3>
                    <p className="text-gray-700 leading-relaxed">박진모 원장의 수학 컨설팅 및 특강 (일부 유료)</p>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-2xl overflow-hidden shadow-xl border border-gray-200 hover:shadow-2xl transition-shadow">
                  ...
                  <div className="p-6 text-center">
                    <h3 className="text-xl font-bold text-gray-900 mb-3">의치약 + SKY 멘토</h3>
                    <p className="text-gray-700 leading-relaxed">1:1 학습상담 (무료)</p>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-2xl overflow-hidden shadow-xl border border-gray-200 hover:shadow-2xl transition-shadow">
                  ...
                  <div className="p-6 text-center">
                    <h3 className="text-xl font-bold text-gray-900 mb-3">SNargo</h3>
                    <p className="text-gray-700 leading-relaxed">수능 수학문제풀이 정확도 99.9% 의 AI<br />(사설 문제도 풀이 가능)</p>
                  </div>
                </div>
              </div>
