...
const executives: TeamMember[] = [
  ...
  },
  {
    ...
    highlight: "15년, 한결같이 학생 곁을 지켜온 시간",
    content: [
      "학원 강단에서 보낸 15년은 단순히 가르치는 시간이 아니었습니다. 수많은 학생들의 흔들림을 함께 겪으며, 어떤 말 한마디가 힘이 되는지, 어떤 순간에 손을 내밀어야 하는지 몸으로 배운 시간이었습니다.",
